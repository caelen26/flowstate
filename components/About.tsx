    ...
    <section id="about" className="bg-[#EBE7DE]">
      ...
      <div className="py-24 px-6 md:px-12 max-w-[1800px] mx-auto flex flex-col md:flex-row items-start gap-16 md:gap-32">
        <div className="md:w-1/3">
          <h2 className="text-4xl md:text-6xl font-serif text-[#2C2A26] leading-tight">
            Born from the earth, <br/> built for the future.
          </h2>
        </div>
        <div className="md:w-2/3 max-w-2xl">
          <p className="text-lg md:text-xl text-[#5D5A53] font-light leading-relaxed mb-8">
            FlowState was founded on a simple but radical premise: to make the invisible visible. Water is the source of all life, yet our daily impact on this vital resource often goes unnoticed.
          </p>
          <p className="text-lg md:text-xl text-[#5D5A53] font-light leading-relaxed mb-8">
            In an age of climate uncertainty, we provide the tools to track, understand, and reduce your water footprint. Through community action and mindful living, we can preserve the flow for generations to come.
          </p>
          <img 
            src="https://images.pexels.com/photos/6583355/pexels-photo-6583355.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" 
            alt="FlowState Design Studio" 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        ...
        <div className="order-1 lg:order-2 flex flex-col justify-center p-12 lg:p-24 bg-[#D6D1C7]">
           <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#5D5A53] mb-6">Data & Insight</span>
